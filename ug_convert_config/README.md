<h2 align="center">Экспорт/импорт конфигурации UTM UserGate</h2>
...
1. Экспорт конфигурации с версии 5:
1.1. Скачать архив <b>ug_convert_config.zip</b>, распаковать, файл <b>ug_convert_config</b> сделать исполняемым.
1.2. Создать в текущей директории каталог <b>data</b>.
1.3. При запуске программа запрашивает ip узла, login и пароль администратора NGFW. Проверьте, что у администратора,
логин которого используете, в профиле включены разрешения для API. Указать ip и login/пароль администратора NGFW версии 5.
1.4. Запустить <b>ug_convert_config</b> в терминале. В каталоге data будут созданы файлы json с текущей конфигурацией.
2. Импорт конфигурации на версию 6:
...
2.2. Запустить <b>ug_convert_config</b> в терминале.
2.3. При запуске программа запрашивает ip узла, login и пароль администратора NGFW. Проверьте, что у администратора,
логин которого используете, в профиле включены разрешения для API. Указать ip и login/пароль администратора NGFW версии 6.
...
keytab-файл, если используется авторизация kerberos и проверить его работу. Затем можно выбрать "Импортировать всё".
Конфигурация из каталога data будет импортирована на NFFW версии 6.
