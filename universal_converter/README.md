...
4. Пока не следует импортировать конфигурацию, полученную с UserGate NGFW. Импорт всех разделов ещё не реализован. Кроме того
импорт реализованных разделов может привести к проблемам, так как не все поля объектов будут перенесены.
