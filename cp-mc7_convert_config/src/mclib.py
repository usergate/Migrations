...
class UtmXmlRpc:
    ...
    def connect(self):
        ...
        try:
            ...
            return 1, f'Error utm.connect: {err} (Node: {self.server_ip}).'
        except rpc.ProtocolError as err:
            return 1, f'Error utm.connect: [{err.errcode}] {err.errmsg} (Node: {self.server_ip}).'
        except rpc.Fault as err:
            return 1, f'Error utm.connect: [{err.faultCode}] {err.faultString} (Node: {self.server_ip}).'
        return self.login()
    ...
    def login(self):
        try:
            ...
            if status == 'work':
                ...
                return 1, f'Error utm.login: UTM не позволяет установить соединение! Status: "{status}".'
        except OSError as err:
            return 1, f'Error utm.login: {err} (Node: {self.server_ip}).'
        except rpc.ProtocolError as err:
            return 1, f'Error utm.login: [{err.errcode}] {err.errmsg} (Node: {self.server_ip}).'
        except rpc.Fault as err:
            return 1, f'Error utm.login: [{err.faultCode}] {err.faultString} (Node: {self.server_ip}).'
        else:
    ...
    def get_product_info(self):
        ...
        try:
            ...
            if err.faultCode == 25:
                ...
                return 1, f'Error utm.get_product_info: [{err.faultCode}] — {err.faultString}'
        return 0, result # 
    ...
    def get_realms_list(self):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.get_realms_list: [{err.faultCode}] — {err.faultString}'
        return 0, result
    ...
    def get_device_templates(self):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.get_device_templates: [{err.faultCode}] — {err.faultString}'
    ...
    def add_device_template(self, template):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.add_device_template: [{err.faultCode}] — {err.faultString}'
...
######## Settings ###########################################################################################
    def set_template_settings(self, template_id, param):
        ...
        try:
            ...
            return 1, f'Error utm.set_template_settings: [{err.faultCode}] — {err.faultString}'
        return 0, result  # Возвращает True
    ...
    def get_template_gateways_list(self, template_id):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.get_template_gateways_list: [{err.faultCode}] — {err.faultString}'
    ...
    def add_template_gateway(self, template_id, gateway):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.add_template_gateway: [{err.faultCode}] — {err.faultString}'
    ...
    def update_template_gateway(self, template_id, gateway_id, gateway):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.update_template_gateway: [{err.faultCode}] — {err.faultString}'
        return 0, result     # Возвращает True
    ...
    def delete_template_gateway(self, template_id, gateway_id):
        ...
        try:
            ...
            if err.faultCode == 5:
                ...
                return 1, f'Error utm.delete_template_gateway: [{err.faultCode}] — {err.faultString}'
        return 0, result     # Возвращает True
...
##################################### DNS ######################################
    def get_template_dns_servers(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_dns_servers: [{err.faultCode}] — {err.faultString}'
    ...
    def get_template_dns_rules(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_dns_rules: [{err.faultCode}] — {err.faultString}'
    ...
    def get_template_dns_static_records(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_dns_static_records: [{err.faultCode}] — {err.faultString}'
...
########################## VPF  #############################################################################
    def get_template_vrf_list(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_routers_list: [{err.faultCode}] — {err.faultString}'
    ...
    def add_template_vrf(self, template_id, vrf_info):
        ...
        try:
            ...
            return 1, f'Error utm.add_template_vrf: [{err.faultCode}] — {err.faultString}'
    ...
    def update_template_vrf(self, template_id, vrf_id, vrf_info):
        ...
        try:
            ...
            return 1, f'Error utm.update_template_vrf: [{err.faultCode}] — {err.faultString}'
        return 0, result     # Возвращает True
...
########################## Zone #############################################################################
    def get_template_zones_list(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_zones_list: [{err.faultCode}] — {err.faultString}'
...
########################## Interfaces #######################################################################
    ...
    def add_template_interface(self, template_id, iface):
        ...
        try:
            ...
            return 1, f'Error utm.add_template_interface: [{err.faultCode}] — {err.faultString}'
...
########################## Library ##########################################################################
    def get_template_services_list(self, template_id):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_services_list: [{err.faultCode}] — {err.faultString}'
    ...
    def get_template_nlists_list(self, template_id, list_type):
        ...
        try:
            ...
            return 1, f'Error utm.get_template_nlists_list: [{err.faultCode}] — {err.faultString}'
...
########################## Политики сети ####################################################################
    def get_template_firewall_rules(self, template_id):
        ...
        try:
            ...
            return 1, f"Error utm.get_template_firewall_rules: [{err.faultCode}] — {err.faultString}"
    ...
    def add_template_firewall_rule(self, template_id, rule):
        ...
        try:
            ...
            return 1, f"Error utm.add_template_firewall_rule: [{err.faultCode}] — {err.faultString}"
    ...
    def update_template_firewall_rule(self, template_id, rule_id, rule):
        ...
        try:
            ...
            return 1, f"Error utm.update_template_firewall_rule: [{err.faultCode}] — {err.faultString}"
        return 0, result     # Возвращает True
...
########################## Политики безопасности ############################################################
    def get_template_content_rules(self, template_id):
        ...
        try:
            ...
            return 1, f"Error utm.get_template_content_rules: [{err.faultCode}] — {err.faultString}"
        return 0, result['items']
    ...
    def add_template_content_rule(self, template_id, rule):
        ...
        try:
            ...
            return 1, f"Error utm.add_template_content_rule: [{err.faultCode}] — {err.faultString}"
        return 0, result     # Возвращает ID добавленного правила
    ...
    def update_template_content_rule(self, template_id, rule_id, rule):
        ...
        try:
            ...
            return 1, f"Error utm.update_template_content_rule: [{err.faultCode}] — {err.faultString}"
        return 0, result     # Возвращает True
