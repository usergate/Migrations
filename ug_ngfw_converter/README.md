...
10. Локальным администраторам при импорте устанавливается статус "disabled". После импорта активируйте их и установите пароль.<br>
...
12. Если вы импортировали сертификат для SSL инспектирования (например CA Default), то необходимо обновить его у всех пользователей.
