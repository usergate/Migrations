...
<h3 align="center">(Версия 2.21)</h3>
...
1.5. После экспорта проверьте вывод программы для исправления найденных ошибок. Исправьте текущую конфигурацию UTM и повторите экспорт.
...
Конфигурация из каталога data будет импортирована на NFFW версии 6.<br>
2.3. После импорта проверьте вывод программы на наличие сообщений, выделенных цветом. Исправьте конфигурацию UTM в соответствие с рекомендациями.
