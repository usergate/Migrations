...
from services import trans_table, trans_filename
...
pattern_drop_rule = re.compile(r";ALLOW|;DENY")
...
def parce_condition_block(block):
        ...
        with open(config_file_path, "r") as fh:
            ...
            while line:
                ...
                if line:
                    ...
                    elif pattern_drop_rule.match(line):
                        print(line)
                        config_data.append(line)
                line = fh.readline()
            config_data.append('')
...
#                print(line)
            ...
            data['conditions'][def_name] = parce_condition_block(def_block[:-1])
        num += 1
