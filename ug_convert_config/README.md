...
логин которого используете, в профиле включены разрешения для API. Указать ip и login/пароль администратора NGFW версии 5.<br>
1.4. Запустить <b>ug_convert_config</b> в терминале. В каталоге data будут созданы файлы json с текущей конфигурацией.<br>
