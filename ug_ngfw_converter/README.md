...
7. В настоящее время реализован только импорт разделов: Библиотеки, UserGate, Сеть, Пользователи и устройства, Политики сети,
Политики безопасности, Глобальный портал, VPN. Импорт остальных разделов ещё в процессе.
