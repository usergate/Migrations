...
1. Импорт в шаблон МС ещё е реализован в полном объёме. Некоторые разделы конфигурации пока не импортируются.<br>
2. В настоящее время при импорте объектов в библиотеки на МС версии 7 не учитывается регистр символов. То есть одинаковые имена
