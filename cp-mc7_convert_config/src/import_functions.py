...
def import_ntp_settings(parent):
    ...
    for i, ntp_server in enumerate(data['ntp_servers']):
        ...
        if err:
            ...
            parent.stepChanged.emit(f'2|NTP-сервер {ntp_server} добавлен.')
...
def import_zones(parent):
    ...
    service_ids = {
        ...
        'Captive portal and block pages': 'ffffff03-ffff-ffff-ffff-ffffff000004',
        'Control XML-RPC': 'ffffff03-ffff-ffff-ffff-ffffff000005',
        'Cluster': 'ffffff03-ffff-ffff-ffff-ffffff000006',
        'VRRP': 'ffffff03-ffff-ffff-ffff-ffffff000007',
        'Administrative console': 'ffffff03-ffff-ffff-ffff-ffffff000008',
        'DNS': 'ffffff03-ffff-ffff-ffff-ffffff000009',
        'HTTP/HTTPS proxy': 'ffffff03-ffff-ffff-ffff-ffffff000010',
        'Authorization agent': 'ffffff03-ffff-ffff-ffff-ffffff000011',
        'SMTP(S) proxy': 'ffffff03-ffff-ffff-ffff-ffffff000012',
        'POP3(S) proxy': 'ffffff03-ffff-ffff-ffff-ffffff000013',
        'CLI over SSH': 'ffffff03-ffff-ffff-ffff-ffffff000014',
        'VPN': 'ffffff03-ffff-ffff-ffff-ffffff000015',
        'SCADA': 'ffffff03-ffff-ffff-ffff-ffffff000017',
        'Reverse proxy': 'ffffff03-ffff-ffff-ffff-ffffff000018',
        'Web portal': 'ffffff03-ffff-ffff-ffff-ffffff000019',
        'SAML server': 'ffffff03-ffff-ffff-ffff-ffffff000022',
        'Log analizer': 'ffffff03-ffff-ffff-ffff-ffffff000023',
        ...
        'SNMP proxy': 'ffffff03-ffff-ffff-ffff-ffffff000026',
        'SSH proxy': 'ffffff03-ffff-ffff-ffff-ffffff000027',
        'Multicast': 'ffffff03-ffff-ffff-ffff-ffffff000028',
        'NTP service': 'ffffff03-ffff-ffff-ffff-ffffff000029',
        'Log collector': 'ffffff03-ffff-ffff-ffff-ffffff000031'
    }
