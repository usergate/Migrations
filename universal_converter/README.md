...
<h3 align="center">(Версия 8.42)</h3>
...
15. <b>Для Kerio:</b><br>
15.1. Выгрузите конфигурацию Kerio и скопируйте все файлы в каталог data_kerio/<i><имя_которое_вы_задали_на_предыдущем_шаге></i>.<br>
16. <b>Для MikroTik:</b><br>
16.1. Переименуйте файл конфигурации MikroTic в <b>mikrotik.cfg</b> и скопируйте его в каталог data_mikrotik/<i><имя_которое_вы_задали_на_предыдущем_шаге></i><br>
17. <b>Для PaloAlto:</b><br>
17.1. Переименуйте файл конфигурации PaloAlto в <b>config.xml</b> и скопируйте его в каталог data_paloalto/<i><имя_которое_вы_задали_на_предыдущем_шаге></i><br>
...
2. В версиях NGFW 6 и 7.0 нельзя добавить более 8 полос пропускания в библиотеку. При добавлении большего количества
получим ошибку.<br>
...
3. Ограничения по интерфейсам не переносятся, т.к. этот функционал отсутствует в UserGate.<br>
...
5. Правила NAT не переносятся так как идеология натирования в UG NGFW очень сильно отличается от Fortigate.<br>
...
<b>Экспорт с Kerio:</b>
1. Группы URL-листов не переносятся, так как данный функционал отсутствует на UserGate NGFW.<br>
2. Доменные пользователи в правилах не конвертируются.<br>
3. Правила NAT не переносятся, так как идеология построения правил NAT в UG NGFW отличается. В общем случае данные правила Kerio
должны быть заменены общими правилами NAT из входящей зоны в исходящую, а вся функциональность реализована правилами МЭ.<br>
...
1. Конвертируется конфигурация только RouteOS версии 7 и выше. Если у вас более старая версия, обновите ваше устройство через
"Check updates".<br>
