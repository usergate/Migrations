...
20.11.2023  Исправлены ошибки экспорта локальных пользователей и групп, профилей DoS.
03.11.2023  Сделана обработка ошибки получения SNMP Engine ID для версии 5, где этого параметра нет.
