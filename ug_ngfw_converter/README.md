...
<p align="center"><img src="main_image.png2"></p>
...
<b>Импорт конфигурации на NGFW:<br>
...
4. Перед импортом убедитесь, что в шаблоне МС существуют необходимые интерфейсы и зоны. Они необходимы для создания VLAN,
subnet DHCP, Gateways и VRF. Если нет интерфейсов, то VLAN, subnet DHCP, Gateways и VRF не будут созданы. Рекомендуется в
первую очередь импортировать зоны, затем создать необходимые интерфейсы для будущих VLAN, шлюзов и VRF и только затем
можно импортировать всё.
5. В настоящее время реализован только импорт Библиотеки. Импорт остальных разделов ещё в процессе.
...
12.08.2024 Реализован импорт разделов  Библиотеки в шаблон МС.<br>
