...
8.2. Правила МЭ со статусом "disabled" не переносятся.</br>
8.3. Правила МЭ с сервисами, отсутствующими на UG NGFW не переносятся.</br>
8.4. Если правила МЭ не содержат dst-address или src-address и назначены на конкретный интерфейс, то такие правила не переносятся.
Для конвертации таких правил, назначьте в "interface list" имена и присвойте соответствующие имена интерфейсам.</br>
8.5. После конвертации, скорее всего, некоторые правила МЭ будут дублироваться. Это связано с идеологией построения правил МЭ на UG NGFW,
...
8.6. Правила NAT не переносятся, так как идеология применения таких правил UG NGFW сильно отличается от MikroTik.</br>
8.8. Переносятся правила "netmap" с chain "dstnat". Такие правила конвертируются в правила DNAT и Port/Forwarding.</b>
8.7. Правила DNAT со статусом "disabled" не переносятся.</br>
8.8. Переносятся настройки:
<pre>
- Часовой пояс                          - "UserGate/Настройки/Часовой пояс"
- Настройки NTP                         - "UserGate/Настройки/Настройки времени сервера"
- Зоны                                  - "Сеть/Зоны"
...
9.5. При импорте правил SNMP, правила v.3 импортируются как v.2<br>
...
10.3. При импорте правил SNMP, правила v.3 импортируются как v.2<br>
11. <b>Импорт на версию UG NGFW 7.0:</b><br>
11.1. При импорте правил SNMP, правила v.3 импортируются как v.2<br>
12. <b>Импорт на версию UG NGFW 7.1:</b><br>
12.1. При импорте правил SNMP, правила v.3 импортируются как v.2<br>
