...
class MainTree(QTreeWidget):
    ...
    def __init__(self):
        ...
        self.compliances = {
            ...
            "UpstreamProxies": "Вышестоящий прокси",
            "UpstreamProxiesRules": "Правила",
            "UpstreamProxiesProfiles": "Профили",
            "UpstreamProxiesServers": "Серверы",
            "WAF": "WAF",
        ...
        data = {
            ...
            "Вышестоящий прокси": ["Серверы", "Профили", "Правила"],
            "VPN": [
        ...
        self.restricted_items = {
            'dcfw-8.0': {
                ...
                "HID профили", "Сценарии", "Тэги", "Вышестоящий прокси", "Правила", "Профили", "Серверы", "Категории URL",
                "Изменённые категории URL", "Вышестоящий прокси", "Правила", "Профили", "Серверы"
            },
            7.4: {
