...
4. Если при импорте правила в шаблон произошли ошибки, то данное правило становится не активным, в начало его имени добавляется
слово "ERROR" и в описание правила добавляются сообщения о произошедших ошибках.<br>
5. <b>Не следует импортировать конфигурацию, полученную с UserGate NGFW.</b> В этом конвертере импорт всех разделов не
