    ...
    def convert_interfaces(x):
        ...
        if '.' in x[1]:
            ...
            match x[2]:
                ...
                case 'ipv4-address':
                    interface = ipaddress.ip_interface(f"{x[3]}/{x[5]}")
                    vlans[ifname]['ipv4'].append({"ip": x[3], "mask": str(interface.netmask)})
                case 'mtu':
...
def create_zone(zone_name, zones):
    ...
    zone = {
        ...
        "services_access": [
            ...
            {
                'enabled': False,
                'service_id': 'Captive portal and block pages',
                'allowed_ips': []
            },
            {
                'enabled': False,
                'service_id': 'Control XML-RPC',
                'allowed_ips': []
            },
            {
                'enabled': False,
            ...
            {
                'enabled': False,
                'service_id': 'Administrative console',
                'allowed_ips': []
            },
            {
                'enabled': False,
            ...
            {
                'enabled': False,
                'service_id': 'HTTP/HTTPS proxy',
                'allowed_ips': []
            },
            {
                'enabled': False,
                'service_id': 'Authorization agent',
                'allowed_ips': []
            },
            {
                'enabled': True,
                'service_id': 'SMTP(S) proxy',
                'allowed_ips': []
            },
            {
                'enabled': True,
                'service_id': 'POP3(S) proxy',
                'allowed_ips': []
            },
            {
                'enabled': False,
                'service_id': 'CLI over SSH',
                'allowed_ips': []
            },
            {
                'enabled': False,
            ...
            {
                'enabled': False,
                'service_id': 'SAML server',
                'allowed_ips': []
            },
            {
                'enabled': False,
                'service_id': 'Log analizer',
                'allowed_ips': []
            },
            {
                'enabled': False,
            ...
            {
                'enabled': False,
                'service_id': 'SNMP proxy',
                'allowed_ips': []
            },
            {
                'enabled': False,
                'service_id': 'SSH proxy',
                'allowed_ips': []
            },
            {
                'enabled': False,
...
def make_dirs(parent, folder):
    if not os.path.isdir(folder):
        try:
            ...
            parent.stepChanged.emit(f'2|Error! Ошибка создания каталога: {folder} - {err}')
            return False
        else:
            return True
    else:
...
def get_objects(parent):
    try:
        ...
        parent.stepChanged.emit(f'2|Error! Ошибка чтения файла: objects.json - {err}')
        return False

def set_objects(parent, objects):
    with open("objects.json", "w") as fh:
