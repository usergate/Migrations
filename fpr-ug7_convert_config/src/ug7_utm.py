...
####################################### Интерфейсы  #######################################
    ...
    def update_routers(self, vrf_id, vrf_info):
    ...
    def add_firewall_rule(self, rule):
        ...
        try:
            ...
            if err.faultCode == 110:
                ...
                return 2, f'\tПравило МЭ "{rule["name"]}" не добавлено, возможно используются русские буквы или спец.симолы в имени правила.\n\t\t{err.faultString}.'
            else:
    ...
    def add_traffic_rule(self, rule):
        ...
        try:
            ...
            if err.faultCode == 111:
                return 2, f'\tПравило NAT "{rule["name"]}" не добавлено, так как русские буквы в имени правила запрещены.\n\t\t{err.faultString}.'
            else:
