...
Программа предназначена для переноса конфигурации из DCFW и NGFW версий 5, 6, 7, 8 на DCFW и NGFW версий 5, 6, 7, 8 и
...
<b>Ограничения:</b>
1. Экспортируются настройки всех интерфесов, но на NGFW/DCFW импортируются только интерфейсы VLAN, VPN и Tunnel. Все остальные надо
будет сделать руками. В шаблоны МС импортируются все интерфейсы.<br>
...
26.12.2024 Рефакторинг библиотек.<br>
