...
<h3 align="center">(Версия 4.40)</h3>
...
1. В настоящее время возможен импорт только групп шаблонов NGFW и DCFW.</b>
...
этом случае тех.поддержка нашей компании ни чем не сможет вам помочь).
...
доменных пользователей и групп в правилах.<br>
5. Если при импорте правил произошла ошибка, такое правило будет не активным. Поэтому, после импорта необходимо проверить
...
17.10.2025 Исправлена провлема больших чисел типа int при импорте в шаблон МС.<br>
