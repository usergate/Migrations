...
3. Скачайте архив <b>convert_config.zip</b> и распакуйте его. Файл <b>ug7_convert_config</b> сделайте исполняемым.
...
6. Запустите <b>ug7_convert_config</b> в терминале.

<b>Примечания:</b>
1. После конвертации сервера авторизации kerbros необходимо в настройках соответствующего LDAP-адаптера ввести необходимый
логин/пароль для коннектора и загрузить keytab файл.
