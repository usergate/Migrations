...
<h3 align="center">(Версия 4.14)</h3>
...
2. Так конкретному устройству, которым управляет МС, привязывается именно группа шаблонов, а не отдельный шаблон, хорошей практикой
...
<b>Импорт конфигурации NGFW в группу шаблонов Management Center</b>
